    ...
    Column(
        ...
        AboutContainer {
            ...
            AboutRow(
                ...
                painterResource = painterResource(R.drawable.ic_facebook)
            ) {
                openLinkFromHref(SocialLinks.AUTHOR_FACEBOOK)
            }
            AboutRow(
                title = stringResource(R.string.Telegram),
                painterResource = painterResource(R.drawable.ic_telegram)
            ) {
                openLinkFromHref(SocialLinks.AUTHOR_TELEGRAM)
            }
        }
    }
}
